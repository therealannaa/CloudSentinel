...
parameters:
\begin{align}
\mathbb{E}[\mathrm{ev\_recall}] &= p_d, &
\mathbb{E}[\mathrm{ev\_prec}] &= \frac{p_d\,g_k}{p_d\,g_k+\rho\,b_k}, \label{eq:idev}\\[2pt]
\mathbb{E}[\mathrm{tech\_recall}] &= p_d\,p_a, &
\frac{\mathbb{E}[\mathrm{tech\_recall}]}{\mathbb{E}[\mathrm{ev\_recall}]} &= p_a, \label{eq:idtech}\\[2pt]
\mathbb{E}[\mathrm{DetRate}] &= 1-(1-p_d)^{g_k}, &
